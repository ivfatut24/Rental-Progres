					...
					<!-- Single Footer Widget Start -->
						<div class="single-footer-widget">
							<div class="widget-body">
								<img src="assets/cardoor/img/logo.png" style="width:180px">
							</div>
						</div>
	...
	<div class="scroll-top">
		<img src="<?php echo base_url() ?>assets/cardoor/img/top-512.png" alt="JSOFT">
	</div>
	<!--== Scroll Top Area End ==-->
	...
	<!--====== Javascripts & Jquery ======-->
    <script src="<?php echo base_url() ?>assets4/js/jquery-3.2.1.min.js"></script>
    <script src="<?php echo base_url() ?>assets4/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url() ?>assets4/js/owl.carousel.min.js"></script>
