						...
						<div class="form-panel">
							...
							<div class="form-horizontal style-form">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input name="ukuran" type="text" id="ukuran" class="form-control" autocomplete="off" placeholder="Ukuran Produk" autocomplete="off" required value="<?= isset($data)?$data->ukuran:''; ?>" />
									</div>
								</div>
								<?php if (isset($data)): ?>
									<div class="form-group">
