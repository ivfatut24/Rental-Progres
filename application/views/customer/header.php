...
<body class="loader-active">
	<!--== Header Area Start ==-->
	<header id="header-area" class="fixed-top d-none">
		<!--== Header Bottom Start ==-->
		<div id="header-bottom" class="d-none d-xl-block">
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4">
						<a href="index2.html" >
							<img src="<?php echo base_url() ?>assets/cardoor/img/logo-v2-putih.png" alt="JSOFT">
						</a>
					</div>
					<!--== Logo End ==-->
					...
					<div class="col-lg-8 d-none d-xl-block">
						<nav class="mainmenu alignright">
							<ul>
								...
								<li><a href='<?php echo base_url("customer/produk"); ?>'>Produk</a>
									<li><a href='<?php echo base_url("customer/keranjang"); ?>'>Keranjang</a></li>
									<li><a href="<?php echo base_url("customer/galery"); ?>">Galery</a></li>
									<li><a class="nav-item nav-link" href="<?= base_url('logout')?>" class="btn btn-default btn-flat" onClick="return confirm ('Apakah Anda Akan Keluar.?');"> Logout </a></li>
								</ul>
							</nav>
						</div>
						<!--== Main Menu End ==-->
